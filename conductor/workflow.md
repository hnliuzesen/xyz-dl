...
3. **Implement Functionality:**
   ...
   - Verify the implementation manually or using existing project tools.
...
2.  **Propose a Detailed, Actionable Manual Verification Plan:**
    ...
    -   The plan you present to the user **must** follow this format:
        ...
        **Manual Verification Steps:**
        1.  **Execute the following command in your terminal:** `python main.py --help`
        2.  **Confirm that you receive:** A list of available commands including the new feature.
        ```
